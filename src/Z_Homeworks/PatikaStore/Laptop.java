...
public class Laptop extends Product {
    Laptop(int id, int stock, double price, double discount, String name, String categories, Brand brand, int storage, int batMHA, int RAM, double inch) {
    ...
    public static int add(int id, Laptop t){
