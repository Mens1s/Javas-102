...
public class Memur extends Calisan {
    ...
    public String getMesai() {return mesai;}
    public void setMesai(String mesai) {this.mesai = mesai;}

    public void calis(){System.out.println("Memur gorevini yapiyor!");}

    @Override
    public void giris(){
        System.out.println(this.getAdSoyad() + " memur c-1 kapisindan giris yapti..");
    }
}
